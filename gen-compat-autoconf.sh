...
gen_config 'CONFIG_BATMAN_ADV14_DEBUG' ${CONFIG_BATMAN_ADV14_DEBUG:="n"} >> "${TMP}"
gen_config 'CONFIG_BATMAN_ADV14_BLA' ${CONFIG_BATMAN_ADV14_BLA:="y"} >> "${TMP}"
gen_config 'CONFIG_BATMAN_ADV14_DAT' ${CONFIG_BATMAN_ADV14_DAT:="y"} >> "${TMP}"
gen_config 'CONFIG_BATMAN_ADV14_NC' ${CONFIG_BATMAN_ADV14_NC:="n"} >> "${TMP}"
