...
export CONFIG_BATMAN_ADV14_DEBUG=n
# B.A.T.M.A.N. bridge loop avoidance:
export CONFIG_BATMAN_ADV14_BLA=y
# B.A.T.M.A.N. distributed ARP table:
export CONFIG_BATMAN_ADV14_DAT=y
# B.A.T.M.A.N network coding (catwoman):
export CONFIG_BATMAN_ADV14_NC=n
...
CONFIG_BATMAN_ADV14=m
batman-adv14-y += compat.o
ifneq ($(REVISION),)
